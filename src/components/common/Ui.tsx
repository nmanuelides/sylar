...
export const UI_ICONS = {
  ...
  palette:
    'M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c2.76 0 5-2.24 5-5 0-4.42-4.03-8-9-8zM6.5 13.5A1.5 1.5 0 118 12a1.5 1.5 0 01-1.5 1.5zm3-4A1.5 1.5 0 119.5 8 1.5 1.5 0 019.5 9.5zm5 0A1.5 1.5 0 1114.5 8a1.5 1.5 0 010 1.5zm3 4a1.5 1.5 0 111.5-1.5 1.5 1.5 0 01-1.5 1.5z',
